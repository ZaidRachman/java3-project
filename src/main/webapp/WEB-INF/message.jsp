    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="send-message" method="post">
                <select class="form-select" name="userSelection">
                    <option selected></option>
                    <option id="choiceText" name="choiceText" value="choiceText">Text</option>
                    <option id="choiceCall" name="choiceCall" value="choiceCall">Call</option>
                </select>
